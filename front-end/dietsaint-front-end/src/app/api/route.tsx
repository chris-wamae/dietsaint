...
{
const response  = await fetch(`http://192.168.100.2:5174/energy-nutrient/by-food-id?id=${id}`)
...
{
const response  = await fetch(`http://192.168.100.2:5174/vitamin/by-food-id?id=${id}`)
...
{
const response  = await fetch(`http://192.168.100.2:5174/ungrouped-nutrient/by-food-id?id=${id}`)
...
{
const response  = await fetch(`http://192.168.100.2:5174/mineral/by-food-id?id=${id}`)
...
const response = await fetch(`http://192.168.100.2:5174/food/search-food-by-name?name=${searchQuery}`)
